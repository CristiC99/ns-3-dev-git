...
#ifndef OFFLOAD_WIFI_MAC_H
#define OFFLOAD_WIFI_MAC_H
 ...
 * DCA, EDCA, etc) but excludes all the high-level MAC functionality
 * (association/disassociation state machines) assumed to be implemented
 * in Linux WiFi stack.
 *
 */
class OffloadWifiMac : public WifiMac
{
public:
  static TypeId GetTypeId (void);

  OffloadWifiMac ();
  virtual ~OffloadWifiMac ();
...
private:
  OffloadWifiMac (const OffloadWifiMac &);
  OffloadWifiMac & operator= (const OffloadWifiMac &);
